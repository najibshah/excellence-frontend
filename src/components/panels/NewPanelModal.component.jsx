...
export function NewPanelModal({ open, setOpen, refresh, setRefresh, boardID }) {
  ...
  const handleSubmit = (event) => {
    ...
    const newBoard = {
      boardID: boardID,
      name: data.get("panelName"),
    };
    axios
      .post(`${apiURI}/edc/boards/addPanel`, newBoard)
      .then((response) => {
